                            ...
                            <form action="{{ route('service.update', $service->id) }}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row mb-4 align-items-center lang-section lang-uz">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" cols="20" rows="2" placeholder="Title UZ" name="title_uz">{{ $service->title_uz }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" cols="20" rows="2" placeholder="Title RU" name="title_ru">{{ $service->title_ru }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" cols="20" rows="2" placeholder="Title EN" name="title_en">{{ $service->title_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-uz">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Qisqacha malumot uz" name="text_uz">{{ $service->text_uz }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="qisqacha malumot ru" name="text_ru">{{ $service->text_ru }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Qisqacha malumot en" name="text_en">{{ $service->text_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-uz">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="description_uz">{{ $service->description_uz }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="description_ru">{{ $service->description_ru }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="description_en">{{ $service->description_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        @if ($service->image)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $service->image) }}" alt="Image" class="img-thumbnail" style="max-width: 200px;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center">
                                    <div class="col-md-6 d-flex justify-content-end w-100">
                                        <a href="{{ route('service.index') }}" type="button" class="btn btn-light btn-default btn-squared w-25">
