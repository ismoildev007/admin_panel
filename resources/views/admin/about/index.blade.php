            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Biz haqimizda</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item">Biz haqimizda</li>
                    </ul>
                </div>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                    <a href="leads-view.html" class="hstack gap-3">
                                                        ...
                                                        <div>
                                                            <span class="text-truncate-1-line">{!! $tm->title_uz!!}</span>
                                                        </div>
                                                    </a>
                                                </td>
                                                <td>{!! Str::limit($tm->description_uz, 30) !!}</td>

                                                <td><img src="/storage/{{ $tm->image }}" height="90px" alt=""></td>
                                                <!-- <td>
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown" style="position: absolute; z-index: 55">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('about.edit', ['about' => $tm->id])}}">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <form class="dropdown-item" action="{{ route('about.destroy', $tm->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                                        @csrf
                                                                        @method('DELETE')
