            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Kompaniya Strukturasi</h5>
                    </div>
                    <ul class="breadcrumb">
                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="{{route('company_structure.create')}}" class="btn btn-primary">
                                <i class="feather-plus me-2"></i>
                                <span>Structura kiritish</span>
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover" id="leadList">
                                        ...
                                        <tbody>
                                        @foreach($companyStructures as $new)
                                            <tr class="single-item">
                                                ...
                                                <td>{!! Str::limit($new->title_uz, 30) !!}</td>
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown" style="position: absolute; z-index: 55">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('company_structure.edit', ['company_structure' => $new->id])}}">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <form class="dropdown-item" action="{{ route('company_structure.destroy', $new->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                                        @csrf
                                                                        @method('DELETE')
