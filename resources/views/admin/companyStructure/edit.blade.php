            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Kompaniya structarisi</h5>
                    </div>
                    <ul class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card stretch stretch-full">
                            <form action="{{ route('company_structure.update', $companyStructure->id) }}" enctype="multipart/form-data" method="post">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row mb-4 align-items-center lang-section lang-uz">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="title_uz">{{ $companyStructure->title_uz }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="title_ru">{{ $companyStructure->title_ru }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="title_en">{{ $companyStructure->title_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        @if ($companyStructure->image)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $companyStructure->image) }}" alt="Image" class="img-thumbnail" style="max-width: 200px;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="row  mb-4 align-items-center">
                                    <div class="col-md-6 d-flex justify-content-end w-100">
                                        <a href="{{ route('company_structure.index') }}" type="submit" class="btn btn-light btn-default btn-squared  w-25">
