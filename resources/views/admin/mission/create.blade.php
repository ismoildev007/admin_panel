            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card stretch stretch-full">
                        <form action="{{ route('mission.store')}}" enctype="multipart/form-data" method="post">
                            @csrf
                            ...
                            <div class="row  mb-4 align-items-center">
                                <div class="col-md-6 d-flex justify-content-end w-100">
                                    <a href="{{ route('mission.index') }}" type="submit" class="btn btn-light btn-default btn-squared  w-25">
