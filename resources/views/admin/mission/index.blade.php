                                ...
                                <table class="table table-hover" id="leadList">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="single-item">
                                            ...
                                            <td>{!! Str::limit($new->description_uz, 30) !!}</td>
                                            <td><img src="/storage/{{ $new->image }}" height="90px" alt=""></td>
                                            <td><a href="{{ asset('storage/' . $new->pdf) }}" target="_blank">PDFni ko'rish</a></td>
                                            <!-- <td>
                                                ...
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    <div class="dropdown" style="position: absolute; z-index: 55">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('mission.edit', ['mission' => $new->id])}}">
                                                            ...
                                                            <li>
                                                                ...
                                                                <form class="dropdown-item" action="{{ route('mission.destroy', $new->id) }}" method="POST" onsubmit="return confirm('O\'chirishga ruxsat berasizmi')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit" class="btn" style="border: none; background: none; cursor: pointer;"><i class="feather feather-trash-2 me-3"></i><span>Delete</span></button>
                                                                </form>
                                                            </li>
                                                        </ul>
                                                    </div>
