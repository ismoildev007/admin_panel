                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown"  style="position: absolute; z-index: 55" >
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('post.edit', ['post' => $new->id])}}">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <form class="dropdown-item" action="{{ route('post.destroy', $new->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                                        @csrf
                                                                        @method('DELETE')
