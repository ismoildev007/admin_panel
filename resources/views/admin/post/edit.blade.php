            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Yangiliklarni Tahrirlash</h5>
                    </div>
                    <ul class="breadcrumb">
                            ...
                            <form action="{{ route('post.update', $post->id) }}" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="col-md-10">
                                        <select name="post_category_id" class="form-control" id="">
                                            @foreach($postCategories as $category)
                                                <option class="text-black" value="{{ $category->id }}" {{ $post->post_category_id == $category->id ? 'selected' : '' }}>{{ $category->name_uz }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-uz">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" cols="20" rows="2" placeholder="Title UZ" name="title_uz">{{ $post->title_uz }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" cols="20" rows="2" placeholder="Title RU" name="title_ru">{{ $post->title_ru }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" cols="20" rows="2" placeholder="Title EN" name="title_en">{{ $post->title_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-uz">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="description_uz">{{ $post->description_uz }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="description_ru">{{ $post->description_ru }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="description_en">{{ $post->description_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            ...
                                            <input type="file" class="form-control" id="usernameInput" placeholder="Image" name="image">
                                ...
                                <div class="row  mb-4 align-items-center">
                                    <div class="col-md-6 d-flex justify-content-end w-100">
                                        <a href="{{ route('post.index') }}" type="submit" class="btn btn-light btn-default btn-squared  w-25">
