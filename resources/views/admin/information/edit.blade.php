            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Oochiq malumotlar</h5>
                    </div>
                    <ul class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card stretch stretch-full">
                            <form action="{{ route('information.update', $information->id) }}" enctype="multipart/form-data" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row mb-4 align-items-center lang-section lang-uz">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" cols="20" rows="2" placeholder="Title UZ" name="title_uz">{{ $information->title_uz }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" cols="20" rows="2" placeholder="Title RU" name="title_ru">{{ $information->title_ru }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" cols="20" rows="2" placeholder="Title EN" name="title_en">{{ $information->title_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-uz">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="description_uz">{{ $information->description_uz }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="description_ru">{{ $information->description_ru }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-type"></i></div>
                                            <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="description_en">{{ $information->description_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="usernameInput" placeholder="Date" name="date" value="{{ $information->date }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        @if ($information->image)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $information->image) }}" alt="Image" class="img-thumbnail" style="max-width: 200px;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
