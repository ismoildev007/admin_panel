                                    ...
                                    <table class="table table-hover" id="leadList">
                                        ...
                                        @foreach($partners as $new)
                                            <tr class="single-item">
                                                ...
                                                <td><a href="javascript:void(0)">{!! $new->description_uz !!}</a></td>
                                                <td>
                                                    <div class="avatar-image avatar-md">
                                                        <img src="{{ asset('storage/' . $new->image) }}" alt="" class="img-fluid">
                                                    </div>
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown"  style="position: absolute; z-index: 55" >
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('partner.edit', ['partner' => $new->id])}}">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <form class="dropdown-item" action="{{ route('partner.destroy', $new->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                                        @csrf
                                                                        @method('DELETE')
