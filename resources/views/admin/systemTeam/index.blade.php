            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="{{route('system_team.create')}}" class="btn btn-primary">
                                        ...
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <a href="leads-view.html" class="hstack gap-3">
                                                    ...
                                                    <div>
                                                        <span class="text-truncate-1-line">{!! $new->full_name!!}</span>
                                                    </div>
                                                </a>
                                            </td>
                                            <td>{!! $new->position_uz !!}</td>
                                            <td>{{ $new->email}}</td>
                                                ...
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    <div class="dropdown" style="position: absolute; z-index: 55">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('system_team.edit', ['system_team' => $new->id])}}">
                                                            ...
                                                            <li>
                                                                ...
                                                                <form class="dropdown-item" action="{{ route('system_team.destroy', $new->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                                    @csrf
                                                                    @method('DELETE')
