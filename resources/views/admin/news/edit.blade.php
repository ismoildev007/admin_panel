                        ...
                        <form action="{{ route('news.update', $news->id) }}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row mb-4 align-items-center lang-section lang-uz">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" cols="20" rows="2" placeholder="Title UZ" name="title_uz">{{ $news->title_uz }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-type"></i></div>
                                        <textarea class="form-control" cols="20" rows="2" placeholder="Title RU" name="title_ru">{{ $news->title_ru }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-type"></i></div>
                                        <textarea class="form-control" cols="20" rows="2" placeholder="Title EN" name="title_en">{{ $news->title_en }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center lang-section lang-uz">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-type"></i></div>
                                        <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="text_uz">{{ $news->text_uz }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-type"></i></div>
                                        <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="text_ru">{{ $news->text_ru }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-type"></i></div>
                                        <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="text_en">{{ $news->text_en }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="usernameInput" placeholder="Date" name="date" value="{{ $news->date }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    @if ($news->image)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $news->image) }}" alt="Image" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                    @endif
                                </div>
                            </div>
