                        ...
                        <form action="{{ route('news.store')}}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row mb-4 align-items-center lang-section lang-uz">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-type"></i></div>
                                        <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="text_uz"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center lang-section lang-ru d-none">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-type"></i></div>
                                        <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="text_ru"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center lang-section lang-en d-none">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <div class="input-group-text"><i class="feather-type"></i></div>
                                        <textarea class="form-control" id="myeditorinstance" cols="30" rows="5" placeholder="Description" name="text_en"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="usernameInput" placeholder="Date" name="date">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center">
