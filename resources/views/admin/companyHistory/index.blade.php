                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="{{route('company_history.create')}}" class="btn btn-primary">
                                <i class="feather-plus me-2"></i>
                                <span>Tarix kiritish</span>
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover" id="leadList">
                                        ...
                                        <tbody>
                                        @foreach($companyHistories as $new)
                                            <tr class="single-item">
                                                ...
                                                <td>{!! Str::limit($new->text_uz, 30) !!}</td>
                                                <td>{{ $new->date}}</td>
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown" style="position: absolute; z-index: 55">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('company_history.edit', ['company_history' => $new->id])}}">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <form class="dropdown-item" action="{{ route('company_history.destroy', $new->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                                        @csrf
                                                                        @method('DELETE')
