                            ...
                            <div class="dropdown-menu nxl-h-dropdown">
                                ...
                                <div class="dropdown nxl-level-menu">
                                    ...
                                    <div class="dropdown-menu nxl-h-dropdown">
                                        ...
                                        <a href="employees-view.html" class="dropdown-item">
                                            <i class="wd-5 ht-5 bg-gray-500 rounded-circle me-3"></i>
                                            <span>Xodimlar View</span>
                                        </a>
                                        <a href="employees-create.html" class="dropdown-item">
                                            <i class="wd-5 ht-5 bg-gray-500 rounded-circle me-3"></i>
                                            <span>Xodimlar Create</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="dropdown nxl-level-menu">
