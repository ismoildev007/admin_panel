    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="index.html" class="b-brand">
                ...
                <img src="/assets/images/impex.svg" alt="" class="logo logo-lg">
                <img src="/assets/images/impex.svg" alt="" class="logo logo-sm">
            </a>
        </div>
            ...
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="javascript:void(0);" class="nxl-link">
                        ...
                        <span class="nxl-mtext">Ximatlar</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                    </a>
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="/admin/home">Bosh sahifa</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="/admin/news">Yangiliklar</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="/admin/company_structure">Kompaniya tuzilmasi</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="/admin/mission">Vazifalar missiyalar </a></li>
...
{{--                        <li class="nxl-item"><a class="nxl-link" href="leads-create.html">Leads Create</a></li>--}}
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="/admin/system_team" class="nxl-link">
                        ...
                        <span class="nxl-mtext">  Tizimidagi hodimlarimiz </span><span class="nxl-arrow"></span>
                    </a>
                </li>
                <li class="nxl-item nxl-hasmenu">
                    <a href="/admin/about" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-layout"></i></span>
                        <span class="nxl-mtext">  About </span><span class="nxl-arrow"></span>
                    </a>
                </li>
                <li class="nxl-item nxl-hasmenu">
                    <a href="/admin/system_team" class="nxl-link">
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="/admin/company_history" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-layout"></i></span>
                        <span class="nxl-mtext">  Kompaniya tarixi </span><span class="nxl-arrow"></span>
                    </a>
                </li>
                <li class="nxl-item nxl-hasmenu">
                    <a href="/admin/service" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-layout"></i></span>
                        <span class="nxl-mtext">   Barcha xizmatlar Service </span><span class="nxl-arrow"></span>
                    </a>
                </li>
                <li class="nxl-item nxl-hasmenu">
                    <a href="/admin/information" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-layout"></i></span>
                        <span class="nxl-mtext">   Ochiq malumotlar </span><span class="nxl-arrow"></span>
                    </a>
                </li>
                <li class="nxl-item nxl-hasmenu">
                    <a href="/admin/post" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-layout"></i></span>
                        <span class="nxl-mtext">   Jis ,Yur Shaxslar malumoti </span><span class="nxl-arrow"></span>
                    </a>
                </li>
                <li class="nxl-item nxl-hasmenu">
